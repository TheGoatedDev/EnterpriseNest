...
import { V1UpdateUserCommandHandler } from '@/application/modules/user/v1/commands/update-user/update-user.handler';
import { V1UpdateUserController } from '@/application/modules/user/v1/commands/update-user/update-user.http.controller';
...
import { V1FindUserByIDQueryHandler } from '@/application/modules/user/v1/queries/find-user-by-id/find-user-by-id.handler';
import { V1FindUserByIDController } from '@/application/modules/user/v1/queries/find-user-by-id/find-user-by-id.http.controller';
